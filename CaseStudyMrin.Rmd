...
sum(is.na(breweries1$ABV))/2410
sum(is.na(breweries1$IBU))/2410
...
```{r}
breweries1 %>% ggplot(aes(x=ABV,y=IBU)) + theme_fivethirtyeight() + geom_point()+geom_smooth(method=lm) + labs(x = "Alcohol By Volume (ABV)",y = "International Bitterness Unit (IBU)", title = "Relationship Between ABV and IBU")
